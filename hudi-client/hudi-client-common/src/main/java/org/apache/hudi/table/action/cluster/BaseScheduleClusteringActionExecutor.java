...
public abstract class BaseScheduleClusteringActionExecutor<T extends HoodieRecordPayload, I, K, O> extends BaseActionExecutor<T, I, K, O, Option<HoodieClusteringPlan>> {

  private final Option<Map<String, String>> extraMetadata;

  public BaseScheduleClusteringActionExecutor(HoodieEngineContext context,
  ...
  protected abstract Option<HoodieClusteringPlan> scheduleClustering();

  @Override
  public Option<HoodieClusteringPlan> execute() {
    Option<HoodieClusteringPlan> planOption = scheduleClustering();
