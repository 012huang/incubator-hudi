...
import org.apache.hudi.table.action.cluster.SparkRunClusteringCommitActionExecutor;
import org.apache.hudi.table.action.cluster.SparkScheduleClusteringActionExecutor;
...
public class HoodieSparkCopyOnWriteTable<T extends HoodieRecordPayload> extends HoodieSparkTable<T> {
  ...
  public Option<HoodieClusteringPlan> scheduleClustering(HoodieEngineContext context,
    ...
    return new SparkScheduleClusteringActionExecutor<>(context, config,this, instantTime, extraMetadata).execute();
  }

  @Override
  public HoodieWriteMetadata<JavaRDD<WriteStatus>> cluster(HoodieEngineContext context,
                                                           String clusteringInstantTime) {
    return new SparkRunClusteringCommitActionExecutor<>(context, config, this, clusteringInstantTime).execute();
  }
