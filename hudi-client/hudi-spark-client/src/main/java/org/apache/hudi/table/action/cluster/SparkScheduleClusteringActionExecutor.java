...
public class SparkScheduleClusteringActionExecutor<T extends HoodieRecordPayload> extends
  ...
  protected Option<HoodieClusteringPlan> scheduleClustering() {
    ...
    ScheduleClusteringStrategy strategy = (ScheduleClusteringStrategy)
        ReflectionUtils.loadClass(config.getScheduleClusteringStrategyClass(), table, context, config);
